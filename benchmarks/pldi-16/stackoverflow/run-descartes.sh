...
do
	echo "Verifying $f"
  echo "Property 1" &> log/$f-p1.log
	{ echo "descartes -p=1 -m=0: "; time descartes -p=1 -m=0 $f; } &>> log/$f-p1.log
	{ echo "descartes -p=1 -m=1: "; time descartes -p=1 -m=1 $f; } &>> log/$f-p1.log
	{ echo "descartes -p=1 -m=2: "; time descartes -p=1 -m=2 $f; } &>> log/$f-p1.log
	{ echo "descartes -p=1 -m=3: "; time descartes -p=1 -m=3 $f; } &>> log/$f-p1.log
done
...
do
	echo "Verifying $f"
  echo "Property 3" &> log/$f-p3.log
	{ echo "descartes -p=3 -m=0: "; time descartes -p=3 -m=0 $f; } &>> log/$f-p3.log
	{ echo "descartes -p=3 -m=1: "; time descartes -p=3 -m=1 $f; } &>> log/$f-p3.log
	{ echo "descartes -p=3 -m=2: "; time descartes -p=3 -m=2 $f; } &>> log/$f-p3.log
	{ echo "descartes -p=3 -m=3: "; time descartes -p=3 -m=3 $f; } &>> log/$f-p3.log
done
